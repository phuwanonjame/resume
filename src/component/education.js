...
function Education() {
  return (
    <Element name="education" className=" bg-black h-screen w-full ">
      ...
      <div className="">
        <div className="flex justify-center items-center text-center max-md:block  ">
          <div className="flex justify-center items-center border-r border-white p-10 max-md:border-none">
            ...
            <div className="flex justify-center items-center p-10">
              <img className=" w-40" src={image} alt=""></img>
            </div>
          </div>

          <div className="  flex flex-col gap-10 justify-around items-center p-10 max-md:p-0  ">
            <div className=" p-5 border border-red-700  w-[400px]">
